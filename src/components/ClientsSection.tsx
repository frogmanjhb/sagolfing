const ClientsSection = () => {
  const clients = [
    { name: 'British Airways', logo: '/images/airlines/British-Airways-Logo.jpg' },
    { name: 'Emirates', logo: '/images/airlines/emirates.jpg' },
    { name: 'Qantas', logo: '/images/airlines/quats.jpg' },
    { name: 'Delta', logo: '/images/airlines/Delta.jpg' },
    { name: 'Air France', logo: '/images/airlines/Air-France.jpg' },
    { name: 'Lufthansa', logo: '/images/airlines/Lufthansa.jpg' },
    { name: 'KLM', logo: '/images/airlines/KLM.jpg' },
    { name: 'Iberia', logo: '/images/airlines/Iberia.jpg' },
    { name: 'Cathay Pacific', logo: '/images/airlines/cathay-pacific.jpg' },
